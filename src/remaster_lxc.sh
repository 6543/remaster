...
iso_source="/opt/desinfect/iso/desinfect-2017.iso"
#destination optinal
#iso_destination="/opt/desinfect/iso/custom_desinfect_`date '+%Y-%m-%d'`.iso"
iso_destination="/opt/desinfect/iso/result/`date '+%Y-%m-%d'`.iso"
iso_lable="DESINFECT_`date '+%Y-%m-%d'`"

#Filesystem (for pxe)
#entweder iso_source oder filesystem_source alls quelle
filesystem_source="/opt/desinfect/extracted/casper/filesystem.squashfs"
...
#LOG
log_file="/opt/desinfect/logs/`date '+%Y-%m-%d'`.log"
log_mail_source="`hostname`@stbaro.bayern.de"
log_mail_smtp="mail.stbv.bybn.de:25"
log_mail_aim="iuk@stbaro.bayern.de"
